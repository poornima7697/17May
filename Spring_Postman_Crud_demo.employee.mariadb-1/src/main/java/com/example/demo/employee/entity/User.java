...
public class User {
	...
	public String toString() {
		return "User [userid=" + userid + ", aitid=" + aitid + ", deptid=" + deptid + ", firstname=" + firstname
				...
				+ ", getUserid()=" + getUserid() + ", getAitid()=" + getAitid() + ", getDeptid()=" + getDeptid()
				+ ", getFirstname()=" + getFirstname() + ", getLastname()=" + getLastname() + ", getDob()=" + getDob()
				+ ", getDoj()=" + getDoj() + ", getUserimage()=" + getUserimage() + ", getAitemail()=" + getAitemail()
				+ ", getContactnumber()=" + getContactnumber() + ", getPassword()=" + getPassword()
				+ ", getReportingmanagerid()=" + getReportingmanagerid() + ", getDesignation()=" + getDesignation()
				+ ", getBenchstatus()=" + getBenchstatus() + ", getUsertype()=" + getUsertype() + ", getUserstatus()="
				+ getUserstatus() + ", getCreatedby()=" + getCreatedby() + ", getCreateddate()=" + getCreateddate()
